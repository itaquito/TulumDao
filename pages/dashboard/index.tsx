...
import MyNFTsGrid from "../../src/components/MyNFTsGrid";
        ...
        return (
            <Container className="my-5">
                <div className="w-100 text-center" style={{ minHeight: "60vh" }}>
                    <BtnGreenSquared onClick={() => push("/investment")}>Invertir</BtnGreenSquared>
                </div>
            </Container>
        );
    }
            ...
            <Container className="my-5">
                <div className={`${classes["grid-container"]}`}>
                    ...
                    <Card className={`${classes["grid-item2"]}`}>
                        <h4 className={`${classes["grid-title"]}`}>Fondos recaudados por Reserva Kaax</h4>
                        <p className={`${classes["grid-text"]}`}>${numberWithCommas(totalSuply * USD_VALUE)} USD</p>
                    </Card>

                    <Card className={`${classes["grid-item3"]}`}>
                        <h4 className={`${classes["grid-title"]}`}>Número de inversionistas</h4>
                        <p className={`${classes["grid-text"]}`}>{numberWithCommas(nOwners)} inversionistas</p>
                    </Card>
                    ...
                    <Card className={`${classes["grid-item6"]} `}>
                        ...
                        <div className={`${classes["info-container"]} `}>
                            <div>
                                <p className={`${classes["info-container__title"]} `}>Ganancia</p>
                            ...
                            <div>
                                <p className={`${classes["info-container__title"]} `}>Total Recibido</p>
                                <p className={`${classes["info-container__currency"]} `}>
                ...
                <div className="p-4 shadow rounded bg-white mt-5">
                    {/* <div className="fw-bold h4 mb-3 me-2">Mis villas</div> */}
                    <MyNFTsGrid />
                </div>
            </Container>
        </>
